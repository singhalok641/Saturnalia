...
public class Rules extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String where = "id = '" + eid + "'";
        RulesDetails = db.fetchByCondition(AppConstants.TABLE_EVENTS,where);
    ...
    public String getStringData(String colName){
        ...
        return  RulesDetails.getString(RulesDetails.getColumnIndexOrThrow(colName));
    }
}
